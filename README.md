...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geeadd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9624&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geeadd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geeadd` can be installed with:

```
conda install geeadd
```

It is possible to list all of the versions of `geeadd` available on your platform with:
